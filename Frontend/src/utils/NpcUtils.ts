...
export function handleNpcImgError(e: { currentTarget: HTMLImageElement }, npcId: string) {
    ...
    const locationSuffixes = ["-monolith", "-visages", "-sirene", "-manor", "-battlefield", "-act3", "-flying-waters", "-ancient-sanctuary", "-esquies-nest", "-yellow-harvest", "-stone-wave-cliffs", "-endless-night", "-frozen-hearts", "-isle-of-the-eyes", "-the-reacher", "-flying-manor"];
